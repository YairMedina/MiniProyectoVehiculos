...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <input type="text" class="form-control" id="iduser" placeholder="Admin or Client" readonly>
      <input type="text" class="form-control" id="idrol" placeholder="Admin or Client" >
    </div>
